  ...
  return {
    ...
    init: {
      ...
      desktop: function() {
        ...
        d.on('contextmenu',  'a.icon', function(ev) {
		  myNotify('IconMenu Enabled..');
      ...
      const normalizePozition = (mouseX, mouseY) => {
        ...
        const outOfBoundsOnX =
          scopeX + iconMenu.clientWidth > scope.clientWidth;

        const outOfBoundsOnY =
          scopeY + iconMenu.clientHeight > scope.clientHeight;
        ...
        if (outOfBoundsOnX) {
          normalizedX =
            scopeOffsetX + scope.clientWidth - iconMenu.clientWidth;
        }

        // ? normalize on Y
        if (outOfBoundsOnY) {
          normalizedY =
            scopeOffsetY + scope.clientHeight - iconMenu.clientHeight;
        }
        ...
        iconMenu.style.top = `${normalizedY}px`;
        iconMenu.style.left = `${normalizedX}px`;
      ...
      scope.addEventListener("click", (e) => {
        ...
        if (e.target.offsetParent != iconMenu) {
          iconMenu.classList.remove("visible");
        }
      });
